...
- Use this when you need to commit changes with a well-structured, standardized message
- This is helpful for maintaining a clean, readable git history
- Use this when pushing code to the current branch safely
- This ensures all commits follow Commitizen (Conventional Commits) standards

## How to use it

### Phase 1: State Detection

Before acting, understand the current delta:
