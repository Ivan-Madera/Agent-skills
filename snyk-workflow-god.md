...
Before scanning, you must purge the current state to ensure the dependency tree is honest.
...
We prioritize the **Snyk IDE Extension** or the **Snyk CLI** to extract deep context.
